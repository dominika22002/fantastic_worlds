...
public:
    ...
    virtual float premia(Zestaw zestaw) const = 0;
    virtual float kara(Zestaw zestaw) const = 0;
    virtual ~karta(){};
};
...
public:
    ...
    int how_much_odd();
    void wyswietl();
    void create(vector<shared_ptr<karta>> talia);
...
void Zestaw::create(vector<shared_ptr<karta>> talia)
{
